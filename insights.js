export const CATEGORIES = {
  food: { label: "Food & Dining", color: "#D2691E", code: "FOOD" },
  groceries: { label: "Groceries", color: "#A98B3F", code: "GROC" },
  transport: { label: "Transport", color: "#4A6FA5", code: "TRNS" },
  shopping: { label: "Shopping", color: "#7A5C7E", code: "SHOP" },
  bills: { label: "Bills & Utilities", color: "#5C6B73", code: "BILL" },
  entertainment: { label: "Entertainment", color: "#C9A24B", code: "ENTM" },
  health: { label: "Health", color: "#6E8F72", code: "HLTH" },
  housing: { label: "Housing & Rent", color: "#8C5A3C", code: "HOME" },
  education: { label: "Education", color: "#3E7C7C", code: "EDUC" },
  travel: { label: "Travel", color: "#B07A8C", code: "TRVL" },
  personal: { label: "Personal Care", color: "#8C82A8", code: "CARE" },
  other: { label: "Other", color: "#8A8470", code: "OTHR" },
};
